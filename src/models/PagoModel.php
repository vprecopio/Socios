...
class Pago {
    ...
    public function registrarPago($id_socio, $mes) {
        $fecha_pago = date('Y-m-d H:i:s');
        $stmt = $this->db->prepare("INSERT INTO pagos (id_socio, fecha_pago, mes) VALUES (?, ?, ?)");
        return $stmt->execute([$id_socio, $fecha_pago, $mes]);
    }
